...
Green_1 = Tree.new({
	Stem.new("Douglass", 2, "Do you like chemistry? Like uh.. you a big fan?", nil),
	Stem.new("Lorelai", 2, "Honestly, yeah. I mean I'm really into make-up, so learning about chemistry-", nil),
	Stem.new("Lorelai", 2, "Especially learning how to formulate shit, it's cool.", nil),
	Stem.new("Douglass", 6, "Make-up is really cool. I mean uh- obviously I don't do make-up-", nil),
	Stem.new("Douglass", 2, "But I like how creative it is, you know?", nil),
